...
\begin{center}
\begin{tikzpicture}[start chain, node distance=-0.075mm, thick, cell/.style={draw, very thin, on chain, minimum size=0.6cm}, endcell/.style={cell, ultra thick, draw=white}]
	\node ({Ad}) [cell] {\ ...\ \ };
	\node ({Ab}) [cell] {$B$};
	\node ({Ab}) [cell] {$B$};
	\node ({Ai}) [cell, ultra thick] {};
...
\begin{tikzpicture}[start chain, node distance=-0.075mm, thick, cell/.style={draw, very thin, on chain, minimum size=0.6cm}]
	...
	%?must be a better way, zadnja črta niti ni naravnost
	\node (ne) at (85bp, 60bp) [draw, minimum width=2cm, minimum height=1.2cm]  {$q_0$};
	\draw (ne.south) -- (85bp, 25bp) -- (115bp, 25bp) [->] to (Ai.north);
\end{tikzpicture}
\end{center}
\ \\
...
\ \\
\begin{center}
\begin{tikzpicture}[start chain=a, start chain=b, node distance=-0.075mm, thick, cell/.style={draw, very thin, minimum size=0.6cm, minimum width=1cm}, cell1/.style={cell, on chain=a}, cell2/.style={cell, on chain=b}]
	\node ({Ai}) [cell1, ultra thick] {$A_{0}$};
	\node ({A1}) [cell1] {$A_{1}$};
	\node ({A1}) [cell1] {$A_{2}$};
	\node ({A1}) [cell1] {$A_{3}$};
	\node ({Ad2}) [cell1] {\ ...\ \ };
	...
	\node ({Ai2}) at (0bp,-0.6cm) [cell2, ultra thick] {\#};
	\node ({A1}) [cell2] {$A_{-1}$};
	\node ({A1}) [cell2] {$A_{-2}$};
	\node ({A1}) [cell2] {$A_{-3}$};
	\node ({Ad2}) [cell2] {\ ...\ \ };

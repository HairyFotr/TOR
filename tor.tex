...
\sect{Prevedbe med modeli regularnih jezikov}%?lame naslov, fixme
...
\item če je $\delta(q,x_i) = \langle p,Y,L \rangle$: 
	...
	\end{items}
\end{items}}
\subsect{Tranzitivna ovojnica $\vdash^*$ relacije $\vdash$}%?je pravi naslov?
...
\subsect{Ugotavljanje pripadnosti besed Turingovemu jeziku}%?made one blockoftext from a lot of text. sm kj zgrešil?

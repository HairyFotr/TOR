...
%\item Če znake označujemo od 0 dalje, je zadnji označen s (p(n)+1)-1
...
\item Dokazati je treba, da pretvornik $M$ za konstrukcijo izraza $M(x)$ potrebuje kvečjemu $O(\log |x|)$ prostora.
\end{enum}

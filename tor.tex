...
\Def{$\varepsilon$-closure($q$)$ = \{ q_k\ |\ \exists q_1, q_2, \dots q_n \in Q,\ q=q_1 \wedge q_i \in \delta(q_{i-1}, \varepsilon) \}$}
...
\section{Dokazovanje da je jezik kontekstno-neodvisen}\label{sec:Dokazovanje KNJ}

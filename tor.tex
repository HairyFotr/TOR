...
\br
\begin{tikzpicture}[start chain, node distance=-0.15mm, cell/.style={draw, on chain, minimum size=0.6cm}]
	\node (ne) at (110bp, 60bp) [draw, thick, minimum height=1.2cm]  {Nadzorna enota};
	...
	\node (dots) [on chain] {$\dots$};

	\draw (ne.south) -- (110bp, 25bp) -- (132bp, 25bp) [->] to (Ai.north);
...
\br\fixme - slika Turingovega stroja z označenim $\alpha_1, \alpha_2$
\br
...
\fixme - slika z vhodno besedo na traku TS\br
...
\fixme - vennov diagram beseda w znotraj L kroga...
...
\fixme - slika TS s števili $i_j$ na traku\br
...
\fixme - slika TS s skupino ničel na traku\br
...
\fixme slika "gube" na traku in slika nadzorne enote

...
\Primer{$P_L eq \mbox{\Quote{Ali je \varphi totalna?}}$\\
Preverimo:\\
...
\Dokaz{
Lastnost funkcij ... od ,,, \\
Naj bo L=\{ \psi | \psi ima lastnost L\}.\\
...
\Dokaz{
$\emptyset$ in $\mathbb{N}$ sta obe odločljivi, zato je taka tudi $\Theta\mathcal{L}$, če je enaka kateremu od njiju.\\%kaj pomeni ES in N sta odl.? Algoritem, ki preveri pripadnost.
Zato vzamemo, da $\Theta\mathcal{L}$ ni niti $\emtpyset$, niti $\mathbb{N}$. Sledi: $\exists a,b: a\in\Theta\mathcal{L} \wedge b\in\overline{\Theta\mathcal{L}}$
...
To pomeni: če bi bil $\Theta\mathcal{L}$ odločljiv, je tudi $\mathcal{K}$, torej $\Theta\mathcal{L}$ ni odločljiv.%šeeno šanso imamo da dokažemo vse
Predpostavimo: $n\in\Theta\mathcal{L}$. Analogno.
}
...
Problem: $Q eq $ \Quote{Al ima Turingov jezik $\mathcal{M} lastnost $L$?}.

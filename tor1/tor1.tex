...
\item $| \mathbb{R} | = | [0,1) |$.\\
	...
	\begin{displaymath}
		\mathbb{R}\rightarrow [0,1): r \rightarrow 0.s\overline{d_1} d_{n} \overline{d_2} d_{n-1} \dots \overline{d_{n-1}} d_2 \overline{d_n} d_1 \overline{d_{n+1}} 0\overline{d_{n+2}} 0 \dots
	\end{displaymath}

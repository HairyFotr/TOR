...
\item P - množica produkcij, $\left[\alpha_1 \rightarrow \alpha_2 \right], \alpha1, \alpha2 \in X$%? not quite
\item S - začetni simbol, $S \in V$
\end{items}
Pri tem pa regularne gramatike ločimo na levo in desno-regularne.
\begin{items}
\item Pri levih - $X=V\circ T^*$%?na pamet epsilon še, pa P redefiniraš
\item Pri desnih - $X=T^* \circ V$%?
\end{items}
 }
